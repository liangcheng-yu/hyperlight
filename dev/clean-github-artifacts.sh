...
gh api repos/deislabs/hyperlight/actions/artifacts?per_page=100 --paginate |
...
cut -d "," -f 1 < HYPERLIGHT_ARTIFACTS_TO_DELETE.txt | xargs -I{} gh api --method DELETE /repos/deislabs/hyperlight/actions/artifacts/{}
