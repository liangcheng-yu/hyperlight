...
impl<'a> Parameter<'a> {
  ...
  pub fn value_type(&self) -> ParameterValue {
    ...
    unsafe { self._tab.get::<ParameterValue>(Parameter::VT_VALUE_TYPE, Some(ParameterValue::NONE)).unwrap()}
  }
  #[inline]
  pub fn value(&self) -> flatbuffers::Table<'a> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Table<'a>>>(Parameter::VT_VALUE, None).unwrap()}
  }
  #[inline]
...
impl flatbuffers::Verifiable for Parameter<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_union::<ParameterValue, _>("value_type", Self::VT_VALUE_TYPE, "value", Self::VT_VALUE, true, |key, v, pos| {
        match key {
          ParameterValue::hlint => v.verify_union_variant::<flatbuffers::ForwardsUOffset<hlint>>("ParameterValue::hlint", pos),
          ParameterValue::hllong => v.verify_union_variant::<flatbuffers::ForwardsUOffset<hllong>>("ParameterValue::hllong", pos),
          ParameterValue::hlstring => v.verify_union_variant::<flatbuffers::ForwardsUOffset<hlstring>>("ParameterValue::hlstring", pos),
          ParameterValue::hlbool => v.verify_union_variant::<flatbuffers::ForwardsUOffset<hlbool>>("ParameterValue::hlbool", pos),
          ParameterValue::hlvecbytes => v.verify_union_variant::<flatbuffers::ForwardsUOffset<hlvecbytes>>("ParameterValue::hlvecbytes", pos),
          _ => Ok(()),
        }
     })?
     .finish();
...
impl<'a: 'b, 'b> ParameterBuilder<'a, 'b> {
  ...
  pub fn add_value_type(&mut self, value_type: ParameterValue) {
    self.fbb_.push_slot::<ParameterValue>(Parameter::VT_VALUE_TYPE, value_type, ParameterValue::NONE);
  }
  #[inline]
  pub fn add_value(&mut self, value: flatbuffers::WIPOffset<flatbuffers::UnionWIPOffset>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Parameter::VT_VALUE, value);
  }
  #[inline]
