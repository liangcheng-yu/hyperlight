...
impl<'a> GuestFunctionDefinition<'a> {
  ...
  pub fn function_name(&self) -> &'a str {
    ...
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(GuestFunctionDefinition::VT_FUNCTION_NAME, None).unwrap()}
  }
  #[inline]
  ...
  pub fn parameters(&self) -> flatbuffers::Vector<'a, ParameterType> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, ParameterType>>>(GuestFunctionDefinition::VT_PARAMETERS, None).unwrap()}
  }
  #[inline]
  pub fn return_type(&self) -> ReturnType {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<ReturnType>(GuestFunctionDefinition::VT_RETURN_TYPE, Some(ReturnType::hlint)).unwrap()}
  }
  #[inline]
  pub fn function_pointer(&self) -> i64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(GuestFunctionDefinition::VT_FUNCTION_POINTER, Some(0)).unwrap()}
  }
}
...
impl flatbuffers::Verifiable for GuestFunctionDefinition<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, ParameterType>>>("parameters", Self::VT_PARAMETERS, true)?
...
impl<'a: 'b, 'b> GuestFunctionDefinitionBuilder<'a, 'b> {
  ...
  pub fn add_function_name(&mut self, function_name: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(GuestFunctionDefinition::VT_FUNCTION_NAME, function_name);
  }
  #[inline]
  pub fn add_parameters(&mut self, parameters: flatbuffers::WIPOffset<flatbuffers::Vector<'b , ParameterType>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(GuestFunctionDefinition::VT_PARAMETERS, parameters);
  }
  #[inline]
  pub fn add_return_type(&mut self, return_type: ReturnType) {
    self.fbb_.push_slot::<ReturnType>(GuestFunctionDefinition::VT_RETURN_TYPE, return_type, ReturnType::hlint);
  }
  #[inline]
  pub fn add_function_pointer(&mut self, function_pointer: i64) {
    self.fbb_.push_slot::<i64>(GuestFunctionDefinition::VT_FUNCTION_POINTER, function_pointer, 0);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> GuestFunctionDefinitionBuilder<'a, 'b> {
  ...
  pub fn finish(self) -> flatbuffers::WIPOffset<GuestFunctionDefinition<'a>> {
    ...
    self.fbb_.required(o, GuestFunctionDefinition::VT_FUNCTION_NAME,"function_name");
    self.fbb_.required(o, GuestFunctionDefinition::VT_PARAMETERS,"parameters");
