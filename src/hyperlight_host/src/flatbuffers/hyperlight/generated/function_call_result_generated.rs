...
impl<'a: 'b, 'b> FunctionCallResultBuilder<'a, 'b> {
  ...
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> FunctionCallResultBuilder<'a, 'b> {
...
#[inline]
pub fn finish_size_prefixed_function_call_result_buffer<'a, 'b>(fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>, root: flatbuffers::WIPOffset<FunctionCallResult<'a>>) {
