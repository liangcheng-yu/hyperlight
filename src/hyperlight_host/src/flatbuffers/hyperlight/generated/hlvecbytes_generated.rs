...
impl<'a> hlvecbytes<'a> {
  ...
  pub fn value(&self) -> Option<flatbuffers::Vector<'a, u8>> {
    ...
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(hlvecbytes::VT_VALUE, None)}
  }
}
...
impl<'a: 'b, 'b> hlvecbytesBuilder<'a, 'b> {
  ...
  pub fn add_value(&mut self, value: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(hlvecbytes::VT_VALUE, value);
  }
  #[inline]
