...
impl<'a> FunctionCall<'a> {
  ...
  pub fn function_name(&self) -> &'a str {
    ...
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(FunctionCall::VT_FUNCTION_NAME, None).unwrap()}
  }
  #[inline]
  ...
  pub fn parameters(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Parameter<'a>>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Parameter>>>>(FunctionCall::VT_PARAMETERS, None)}
  }
  #[inline]
  pub fn function_call_type(&self) -> FunctionCallType {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<FunctionCallType>(FunctionCall::VT_FUNCTION_CALL_TYPE, Some(FunctionCallType::none)).unwrap()}
  }
  #[inline]
  pub fn expected_return_type(&self) -> ReturnType {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<ReturnType>(FunctionCall::VT_EXPECTED_RETURN_TYPE, Some(ReturnType::hlint)).unwrap()}
  }
}
...
impl flatbuffers::Verifiable for FunctionCall<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<FunctionCallType>("function_call_type", Self::VT_FUNCTION_CALL_TYPE, false)?
     .visit_field::<ReturnType>("expected_return_type", Self::VT_EXPECTED_RETURN_TYPE, false)?
     .finish();
    Ok(())
  }
}
...
impl<'a: 'b, 'b> FunctionCallBuilder<'a, 'b> {
  ...
  pub fn add_function_name(&mut self, function_name: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(FunctionCall::VT_FUNCTION_NAME, function_name);
  }
  #[inline]
  pub fn add_parameters(&mut self, parameters: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<Parameter<'b >>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(FunctionCall::VT_PARAMETERS, parameters);
  }
  #[inline]
  pub fn add_function_call_type(&mut self, function_call_type: FunctionCallType) {
    self.fbb_.push_slot::<FunctionCallType>(FunctionCall::VT_FUNCTION_CALL_TYPE, function_call_type, FunctionCallType::none);
  }
  #[inline]
  pub fn add_expected_return_type(&mut self, expected_return_type: ReturnType) {
    self.fbb_.push_slot::<ReturnType>(FunctionCall::VT_EXPECTED_RETURN_TYPE, expected_return_type, ReturnType::hlint);
  }
  #[inline]
  ...
  pub fn finish(self) -> flatbuffers::WIPOffset<FunctionCall<'a>> {
    ...
    self.fbb_.required(o, FunctionCall::VT_FUNCTION_NAME,"function_name");
...
pub fn size_prefixed_root_as_function_call(buf: &[u8]) -> Result<FunctionCall, flatbuffers::InvalidFlatbuffer> {
...
#[inline]
pub fn finish_size_prefixed_function_call_buffer<'a, 'b>(fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>, root: flatbuffers::WIPOffset<FunctionCall<'a>>) {
