...
pub struct SandboxMemoryLayout {
    ...
    stack_size: usize,
    heap_size: usize,
    host_functions_offset: usize,
    host_exception_offset: usize,
    guest_error_message_offset: usize,
    code_and_outb_pointer_offset: usize,
    input_data_offset: usize,
    output_data_offset: usize,
    heap_data_offset: usize,
    stack_data_offset: usize,
    sandbox_memory_config: SandboxMemoryConfiguration,
    code_size: usize,
    host_functions_buffer_offset: usize,
    host_exception_buffer_offset: usize,
    guest_error_message_buffer_offset: usize,
    input_data_buffer_offset: usize,
    output_data_buffer_offset: usize,
    guest_heap_buffer_offset: usize,
    guest_stack_buffer_offset: usize,
