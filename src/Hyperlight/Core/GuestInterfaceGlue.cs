...
namespace Hyperlight
{
    abstract class GuestInterfaceGlue
    {
        ...
        // If null, we are dealing with a helpers/delegates defined on a static class
        ...
        public GuestInterfaceGlue(object guestObjectOrType)
        {
            ...
            foreach (var fieldInfo in type.GetFields(bindingFlags))
            {
                ...
                if (typeof(Delegate).IsAssignableFrom(fieldInfo.FieldType))
                {
                    ...
                    //     return Test2("GuestFunction", new object[] {o1,o2,o3,o4,o5,o6,o7,o8,o9,o10,o11});
                    //   }
                    //
                    ...
                    // First parameter to DispatchToGuest the GuestInterfaceGlue 'this' poitner that will be passed to the delegate
                    il.Emit(OpCodes.Ldarg_0);

                    // Second parameter to DispatchToGuest is the name of the function being called
            ...
            // Only inclide instance methods if we have a target.
